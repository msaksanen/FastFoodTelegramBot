...
namespace FastFoodTelegramBot.Commands
{
    class ViewCmd:ICommand
    {
        public static async Task Command(ITelegramBotClient botClient, long id, string? msg, string? firstName, string? lastName)
        {
            ...
            await botClient.SendTextMessageAsync(id, $"View our catalogue, please.", 
                  replyMarkup: KbdMaker.InKeyboard(CmdItemInit.MainProdCatBtn)); //CommandNames.MainCatBtnCmd earlier
        }
    }
}
